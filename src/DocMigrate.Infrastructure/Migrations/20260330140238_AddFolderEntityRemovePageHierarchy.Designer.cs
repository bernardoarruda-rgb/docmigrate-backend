...
namespace DocMigrate.Infrastructure.Migrations
{
    ...
    [Migration("20260330140238_AddFolderEntityRemovePageHierarchy")]
    partial class AddFolderEntityRemovePageHierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DocMigrate.Domain.Entities.Page", b =>
                {
                    ...
                    b.Property<string>("ContentWidth")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasDefaultValue("normal")
                        .HasColumnName("larguraconteudo");

                    b.Property<string>("CoverAttribution")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("atribuicaocapa");

                    b.Property<int>("CoverPosition")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(50)
                        .HasColumnName("posicaocapa");

                    b.Property<string>("CoverType")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("tipocapa");

                    b.Property<string>("CoverValue")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("valorcapa");
